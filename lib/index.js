                        ...
                        it("should respond without error to a " + operationElement.method + " on the " + apiElement.path + " endpoint", function(done) {
                            ...
                            self.generateValidRequest(
                                ...
                                .end(function(err, res) {
                                    ...
                                    assert.equal(2, Number(String(res.statusCode).charAt(0)), "Should respond with a 2xx status code but receved " + res.statusCode + " for the reason: " + JSON.stringify(res.body));
